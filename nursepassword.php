...
if(isset($_POST['sub']))
{
	...
	$query = "select * from nurse where NurseID = '$username' ";
	...
	if($result == 1)
	{
     ...
     $_SESSION["show_nurse_id"] = $username;
     
    
     header("location:viewOnlyNurse.php");

	}
	else
	{
		 header("location:nursepassword.php?invalid=Your User Name or Password is Incorrect Please * TRY AGAIN *");
	}
