...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2017 at 08:24 AM
...
ON examined_by (PatientID);

CREATE INDEX deindex
ON examined_by (DoctorID);
...
CREATE INDEX ntindex
ON takecareof (NurseID);

CREATE INDEX ptindex
ON takecareof (PatientID);
...
--
ALTER TABLE `bed`
  MODIFY `BedID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT for table `doctor`
--
ALTER TABLE `doctor`
  MODIFY `DoctorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
ALTER TABLE `nurse`
  MODIFY `NurseID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
ALTER TABLE `bed`
  ADD CONSTRAINT `BED_ibfk_1` FOREIGN KEY (`RoomID`) REFERENCES `room` (`RoomID`) ON DELETE CASCADE;
...
ALTER TABLE `examined_by`
  ...
  ADD CONSTRAINT `examined_by_ibfk_2` FOREIGN KEY (`DoctorID`) REFERENCES `doctor` (`DoctorID`) ON DELETE CASCADE;
...
--
ALTER TABLE `takecareof`
  ADD CONSTRAINT `takeCareOF_ibfk_1` FOREIGN KEY (`NurseID`) REFERENCES `nurse` (`NurseID`) ON DELETE CASCADE,
